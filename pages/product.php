...
$result_product = mysqli_query($kon, "SELECT * FROM tabel_product ORDER BY id ASC");
?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="add_product.php" class="btn btn-primary mb-3"><i class="fa fa-plus-square"></i>  Tambah Produk</a>
                            </div>
                            <!-- /.panel-heading -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        while ($dataProduct = mysqli_fetch_array($result_product)) {
                                            ...
                                            echo "<td><a href='edit_product.php? id=$dataProduct[id]' class='btn btn-warning'><i class='fa fa-edit'></i> Edit</a> <a href='delete_product.php? id=$dataProduct[id]' class='btn btn-danger'><i class='fa fa-trash'></i> Delete</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </table>
