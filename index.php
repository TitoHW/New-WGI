...
<link rel="icon" type="image/png" href="img/logo/logo_globalindo.png">
  ...
  <section class="about scrollspy" id="about">
    <div class="container" style="height: 600px;">
      <div class="row">
        ...
        <div class="row">
          <div class="col m8">
            <p style="text-align: justify;">To be a global company in the garment industry that always make continuous improvements on quality, security and work safety as well as legality. Long-term oriented relationships on mutual benefit of internal and external parties.</p>
          </div>
          <div class="col m4">
        ...
        <div class="col m7 12">
          <form>
            <div class="card-panel">
              ...
              <div class="input-field">
                <textarea type="text" name="message" id="message" class="materialize-textarea" style="height: 88px;"></textarea>
                <label for="message">Message</label>
              </div>
              <button type="submit" class="btn center-align">Send</button>
            </div>
          </form>
        </div>
